...
//        this.Escena.fog = new THREE.Fog(0x888888, 10.1, 150);
        ...
        this.PrecisionAnalizador = this.Audio.Iniciar(this.EsMovil(), this, 
                                    function() { this.CancionCargada(); this.PlayPausa(); }.bind(this), // Función CanPlay
                                    this.CancionTerminada.bind(this) );                                 // Función Ended
        
        this.Audio.CargarCancion(RandInt(6));
    ...
    PlayPausa : function() {
        var p = this.Audio.PlayPausa();
        if (p === false) { // pausa
            this.PlanoTextura[1].visible = true;
            this.PlanoTextura[2].visible = false;
        }
        else { // play
            this.PlanoTextura[1].visible = false;
            this.PlanoTextura[2].visible = true;            
        }
    },
...
//        this.BufferIcos[0].Context.fillRect(0, 0, this.BufferIcos[0].Ancho, this.BufferIcos[0].Alto);
    ...
    PintarPantalla_Solar : function(Buffer, Tick) {        
        ...
        var Avance = this.Constantes.PIx2 / TamBuffer;
        var Angulo = Tick;
        ...
        Buffer.Context.beginPath();        
        Buffer.Context.arc(mx, my, 30 + this.MediaAudio[0], 0, this.Constantes.PIx2, false);
        Buffer.Context.stroke();
        ...
        Buffer.Context.beginPath();        
        Buffer.Context.arc(mx, my, 38 + this.MediaAudio[1], 0, this.Constantes.PIx2, false);
        Buffer.Context.stroke();
        ...
        Buffer.Context.beginPath();        
        Buffer.Context.arc(mx, my, 46 + this.MediaAudio[2], 0, this.Constantes.PIx2, false);
        Buffer.Context.stroke();
    ...
    PintarPantalla_Circular8 : function(Buffer, Tick) {
        ...
        var RadAvance = (this.Constantes.PIx2) / Porcion;
    ...
    PintarPantalla_Circular : function(Buffer, Tick) { 
        ...
        var TamBuffer = 1024;
        if (this.Audio.Analizador)  { TamBuffer = this.Audio.Analizador.fftSize / 2; }
        var RadAvance = this.Constantes.PIx2 / (TamBuffer * 2);
        var Rad = -Math.PI / 2, x = 0, y = 0;       
        var mx = (Buffer.Ancho / 2);
        var my = (Buffer.Alto / 2);
...
//        var Compatibilidad = window.AudioContext || window.webkitAudioContext;
        ...
        this.Padre = Padre;
        this.Canciones =[            
            { Grupo : "JT Bruce",            Titulo : "Battle Trance",                         Año : "2015",    Path : "yaog_02.mp3",                                      Web : "#" },
            { Grupo : "Fallen to Flux",      Titulo : "One Chance",                            Año : "2014",    Path : "yaog_02.mp3",                                         Web : "#" },
            { Grupo : "From Sky to Abyss",   Titulo : "Quantum Ocean",                         Año : "2016",    Path : "yaog_02.mp3",                                      Web : "#" }, 
            { Grupo : "In Camera",           Titulo : "Nothing's Over",                        Año : "2016",    Path : "yaog_02.mp3",                        Web : "#" },
            { Grupo : "LevenRain",           Titulo : "ActionMan Versus The CyberParasites",   Año : "2016",    Path : "yaog_02.mp3",   Web : "#" },
            { Grupo : "Convergence",         Titulo : "Six Feet Under",                        Año : "2007",    Path : "yaog_02.mp3",                      Web : "#" }
        ];
    ...
    this.CargarCancion = function(PosCancion) {        
        ...
        this.Cancion.src = "http://jq22.qiniudn.com/" + this.Canciones[PosCancion].Path;
